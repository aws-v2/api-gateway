error id: file://<WORKSPACE>/src/main/java/com/microservices/gateway/filter/AuthenticationFilter.java:_empty_/ServerWebExchange#
file://<WORKSPACE>/src/main/java/com/microservices/gateway/filter/AuthenticationFilter.java
empty definition using pc, found symbol in pc: _empty_/ServerWebExchange#
...
public class AuthenticationFilter implements GlobalFilter, Ordered {
    ...
    private static final List<String> PUBLIC_ENDPOINTS = List.of(
        ...
        "/api/v1/s3/health","/api/v1/ec2/health","/api/v1/rds/health","/api/v1/lambda/health","/api/v1/sagemaker/health",
    ...
    @Override
    public Mono<Void> filter(ServerWebEx@@change exchange, GatewayFilterChain chain) {
		...
		System.out.println("====> uwthMethod: "+authMethod+" Url:"+exchange.);
