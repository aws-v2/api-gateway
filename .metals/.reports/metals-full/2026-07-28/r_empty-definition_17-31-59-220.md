error id: file://<WORKSPACE>/src/main/java/com/microservices/gateway/filter/AuthenticationFilter.java:java/lang/System#
...
public class AuthenticationFilter implements GlobalFilter, Ordered {
	...
	public Mono<Void> filter(ServerWebExchange exchange, GatewayFilterChain chain) {
		...
		case "query":
			...
			Sy@@stem.out.println("====> uwthMethod: " + userId + " Url: " + role);
