error id: file://<WORKSPACE>/src/main/java/com/microservices/gateway/filter/AuthenticationFilter.java:_empty_/ServerWebExchange#getRequest#
...
public class AuthenticationFilter implements GlobalFilter, Ordered {
    ...
    public Mono<Void> filter(ServerWebExchange exchange, GatewayFilterChain chain) {
		...
		System.out.println("====> uwthMethod: "+authMethod+" Url:"+exchange.getR@@equest());
