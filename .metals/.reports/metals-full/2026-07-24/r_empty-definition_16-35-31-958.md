error id: file://<WORKSPACE>/src/main/java/com/microservices/gateway/filter/JwtAuthenticationFilter.java:_empty_/HttpMethod#OPTIONS#
...
public class JwtAuthenticationFilter implements GatewayFilter {
	...
	public Mono<Void> filter(ServerWebExchange exchange, GatewayFilterChain chain) {
        ...
        String requestId = (String)UUID.randomUUID();

		if (request.getMethod() == HttpMethod.OPTION@@S) {
