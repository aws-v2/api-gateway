error id: file://<WORKSPACE>/src/main/java/com/microservices/gateway/filter/JwtAuthenticationFilter.java:_empty_/JwtUtil#extractUsername#
file://<WORKSPACE>/src/main/java/com/microservices/gateway/filter/JwtAuthenticationFilter.java
empty definition using pc, found symbol in pc: _empty_/JwtUtil#extractUsername#
...
public class JwtAuthenticationFilter implements GatewayFilter {
	...
	private Mono<Void> handleBearerToken(ServerWebExchange exchange, GatewayFilterChain chain, String token,
		...
		String userId = jwtUtil.extractUserId(token);exchange.getRequest
	...
	private Mono<Void> handleApiKey(ServerWebExchange exchange, GatewayFilterChain chain, String apiKey, String path) {
		...
		String role = jwtUtil.e(token);
		String email = jwtUtil.extractUse@@rname(token);
