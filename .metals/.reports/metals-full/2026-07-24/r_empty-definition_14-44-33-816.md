error id: file://<WORKSPACE>/src/main/java/com/microservices/gateway/util/JwtUtil.java:jakarta/annotation/PostConstruct#
file://<WORKSPACE>/src/main/java/com/microservices/gateway/util/JwtUtil.java
empty definition using pc, found symbol in pc: jakarta/annotation/PostConstruct#
empty definition using semanticdb
empty definition using fallback
non-local guesses:

offset: 245
uri: file://<WORKSPACE>/src/main/java/com/microservices/gateway/util/JwtUtil.java
text:
```scala
...
import jakarta.annotation.Pos@@tConstruct;
