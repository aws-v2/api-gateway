error id: file://<WORKSPACE>/src/main/java/com/microservices/gateway/config/GatewayConfig.java:com/microservices/gateway/filter/JwtAuthenticationFilter#
file://<WORKSPACE>/src/main/java/com/microservices/gateway/config/GatewayConfig.java
empty definition using pc, found symbol in pc: com/microservices/gateway/filter/JwtAuthenticationFilter#
...
import com.microservices.gateway.filter.JwtAuthenticati@@onFilter;
...
.route("gamelift-sse", r -> r
    ...
    .uri("lb://gamelift-server"))
                ...
                .route("gamelift-ws", r -> r
                        .path(apiVersion + "/ws/**")
                        .filters(f -> f
                                .stripPrefix(0))
                        .uri("lb:ws://gamelift-server"))
