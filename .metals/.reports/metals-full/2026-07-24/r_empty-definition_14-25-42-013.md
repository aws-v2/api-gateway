error id: file://<WORKSPACE>/src/main/java/com/microservices/gateway/filter/JwtAuthenticationFilter.java:_empty_/ServerWebExchange#getRequest#
file://<WORKSPACE>/src/main/java/com/microservices/gateway/filter/JwtAuthenticationFilter.java
empty definition using pc, found symbol in pc: _empty_/ServerWebExchange#getRequest#
...
public class JwtAuthenticationFilter implements GatewayFilter {
	...
	private Mono<Void> handleBearerToken(ServerWebExchange exchange, GatewayFilterChain chain, String token,
		...
		ServerHttpRequest modified = exchange.getRequ@@est().mutate()
